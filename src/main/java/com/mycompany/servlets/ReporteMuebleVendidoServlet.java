...
public class ReporteMuebleVendidoServlet extends HttpServlet{
    ...
    public String getReporte(HttpServletRequest request) {
        ...
        List<Compra> listaCompra = (ArrayList<Compra>) new Obtencion().getFacturaMuebleV(request.getParameter("nombreMueble"), (String)request.getAttribute("fechaInicial"),(String)request.getAttribute("fechaFinal"));
    ...
    public void reporte(HttpServletResponse response, String reporte){
        ...
        response.setHeader("Content-Disposition", "attatchment; filename=reporteMuebleMasVendido.csv");
