        ...
        <div class="container col-lg-3">
            <form action="agregar-usuario-servlet" method="post">
                <div class="form-group">
                    <center><label><strong>Agregar Nuevo Usuario</strong></label></center><br>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="txtpass" class="form-control" placeholder="Ingrese su Contraseña" minlenght="8" required>
                    </div>

                    <div class="form-group">
                        <label>Verificación de Contraseña</label>
                        <input type="password" name="txtver" class="form-control" placeholder="Ingrese su contraseña nuevamente" minlenght="8" required>
                    </div>
                    ...
                    <input type="submit" class="btn btn-block" name ="agregar" value="Agregar"><br>
