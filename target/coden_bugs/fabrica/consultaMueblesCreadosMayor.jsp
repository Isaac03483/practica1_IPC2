...
<%
    List<MuebleEnsamblado> listaMuebles = (ArrayList<MuebleEnsamblado>)new Obtencion().getMueblesCreados(Constante.ASCENDENTE);
%>
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="lateral txt-center">
                ...
                <a href="/coden_bugs/fabrica/consultaMueblesCreadosMenor.jsp" class="btn btn-block">Ordenar de forma Descendente</a><br>
